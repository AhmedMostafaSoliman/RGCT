...
#SBATCH --job-name=rgct_meta_cifar100

# W&B hyperparameter sweep agent for RGCT on Meta-CIFAR100.
# Uses the already-created sweep:
#   https://wandb.ai/leathead_AQ_AM_IO/RGCT/sweeps/r6828xt1
#
# Usage:
#   DATADIR=/path/to/meta-dataset/processed_data sbatch meta_cifar100_no_ctb_sweep.sh
#   DATA_DIR=/path/to/meta-dataset/processed_data bash meta_cifar100_no_ctb_sweep.sh

set -eo pipefail

# ============================ EDIT THESE ============================
DATASET="Meta-CIFAR100"
SWEEP_ID="leathead_AQ_AM_IO/RGCT/r6828xt1"
