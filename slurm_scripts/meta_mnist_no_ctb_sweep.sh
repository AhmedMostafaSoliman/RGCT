...
#SBATCH --job-name=rgct_meta_mnist

# W&B hyperparameter sweep agent for RGCT on Meta-MNIST.
# Uses the already-created sweep:
#   https://wandb.ai/leathead_AQ_AM_IO/RGCT/sweeps/gfqudwgg
#
# Usage:
#   DATADIR=/path/to/meta-dataset/processed_data sbatch meta_mnist_no_ctb_sweep.sh
#   DATA_DIR=/path/to/meta-dataset/processed_data bash meta_mnist_no_ctb_sweep.sh

set -eo pipefail

# ============================ EDIT THESE ============================
DATASET="Meta-MNIST"
SWEEP_ID="leathead_AQ_AM_IO/RGCT/gfqudwgg"
