...
#SBATCH --job-name=rgct_meta_traffic

# W&B hyperparameter sweep agent for RGCT on Meta-TrafficSign.
# Uses the already-created sweep:
#   https://wandb.ai/leathead_AQ_AM_IO/RGCT/sweeps/smiq5y40
#
# Usage:
#   DATADIR=/path/to/meta-dataset/processed_data sbatch meta_traffic_sign_no_ctb_sweep.sh
#   DATA_DIR=/path/to/meta-dataset/processed_data bash meta_traffic_sign_no_ctb_sweep.sh

set -eo pipefail

# ============================ EDIT THESE ============================
DATASET="Meta-TrafficSign"
SWEEP_ID="leathead_AQ_AM_IO/RGCT/smiq5y40"
