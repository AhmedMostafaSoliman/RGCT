...
#SBATCH --job-name=rgct_meta_cifar10

# W&B hyperparameter sweep agent for RGCT on Meta-CIFAR10.
# Uses the already-created sweep:
#   https://wandb.ai/leathead_AQ_AM_IO/RGCT/sweeps/zwxwodrf
#
# Usage:
#   sbatch meta_cifar10_no_ctb_sweep.sh
#   DATADIR=/path/to/meta-dataset/processed_data sbatch meta_cifar10_no_ctb_sweep.sh

set -eo pipefail

# ============================ EDIT THESE ============================
DATASET="Meta-CIFAR10"
SWEEP_ID="leathead_AQ_AM_IO/RGCT/zwxwodrf"
...
# ====================================================================
module load python/3.11 gcc cuda opencv/4.10 cudnn
if [ -z "$DATADIR" ]; then
